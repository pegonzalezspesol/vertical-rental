    ...
    def action_confirm(self):
        ...
        if self.all_line:
            if self.date_in_line:
                for line in self.line_ids:
                    message_body += _(
                        "<li>%(line_product_name)s: %(line_start_date)s - "
                        "%(line_end_date)s -> %(date_start)s - %(date_end)s</li>",
                        line_product_name=line.order_line_id.product_id.name,
                        line_start_date=line.order_line_id.start_date,
                        line_end_date=line.order_line_id.end_date,
                ...
                message_body += _(
                    "<li>(All lines): %(default_start_date)s - %(default_end_date)s "
            ...
            if self.date_in_line:
                ...
                message_body += _(
                    "<li>(Lines: %(from_line)s - %(to_line)s): %(default_start_date)s "
                    "- %(default_end_date)s -> %(date_start)s - %(date_end)s</li>",
